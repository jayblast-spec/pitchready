  ...
  return (
    <footer className="border-t border-border px-4 py-16">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-10 text-center text-xs text-muted/50">PitchReady · Built by <a href="https://arknet.digital" target="_blank" rel="noopener noreferrer" className="hover:text-muted transition-colors">ArkNet Digital</a></p>
      </div>
    </footer>
  );
}
