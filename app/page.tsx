...
const product = {"repo":"PitchReady","suite":"Creator / Founder Tools","category":"Investor readiness","audience":"founders, accelerators, consultants, and startup studios","promise":"stress-test a pitch until the story, market, and ask are impossible to ignore","inputLabel":"Startup idea, traction, or pitch notes","placeholder":"AI-native knowledge platform that generates products from reusable memory","primary":"Review pitch","gradient":"from-indigo-300 via-blue-300 to-cyan-300","metrics":["VC critique","Ask clarity","Risk map"],"modules":["Narrative audit","Market wedge","Moat pressure test","Financial ask review","Investor question prep"],"outputs":["Pitch score","Weakest assumption","Investor-ready rewrite","Next proof milestone"],"pricing":"Free pitch scan, $49/month Founder, $249/month Studio review room."} as const;
